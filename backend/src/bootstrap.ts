...
export async function initializeDatabase() {
  ...
  const products = [
    { name: 'ノートPC', description: '高性能ノートパソコン', price: 120000, category: '電子機器', stock: 5, image_url: 'https://picsum.photos/seed/laptop-2026/600/400' },
    { name: 'マウス', description: 'ワイヤレスマウス', price: 3500, category: '電子機器', stock: 20, image_url: 'https://picsum.photos/seed/mouse-2026/600/400' },
    { name: 'TシャツA', description: 'カジュアルTシャツ', price: 2500, category: 'ファッション', stock: 30, image_url: 'https://picsum.photos/seed/tshirt-2026/600/400' },
    { name: 'ジーンズ', description: 'ブルージーンズ', price: 8000, category: 'ファッション', stock: 15, image_url: 'https://picsum.photos/seed/jeans-2026/600/400' },
    { name: 'プログラミング入門', description: 'JavaScript基礎', price: 3500, category: '書籍', stock: 10, image_url: 'https://picsum.photos/seed/book-2026/600/400' },
    { name: 'チョコレート', description: 'ダークチョコ200g', price: 1500, category: '食品', stock: 50, image_url: 'https://picsum.photos/seed/choco-2026/600/400' },
  ];
